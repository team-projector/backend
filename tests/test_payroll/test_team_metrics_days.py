...
#                              roles=TeamMember.roles.leader)
#
#     _create_spent_time(timezone.now() - timedelta(days=4),
#                        timedelta(hours=3))
#
...
#
#     developer_metrics = next(
#         item for item in metrics if item['user'] == developer.id)
#
#     assert developer_metrics['user'], developer.id)
#     assert len(developer_metrics['metrics']),
#                 (end - start).days + 1)
#
#     _check_metrics(developer_metrics['metrics'],
#                    {
#                        timezone.now() - timedelta(days=4): timedelta(
#                            hours=3),
#                    }, {}, {
...
#
#     _create_spent_time(timezone.now(), timedelta(hours=1),
#                        issue=issue_2)
#     _create_spent_time(timezone.now(), timedelta(hours=2),
#                        issue=issue_2)
#     _create_spent_time(timezone.now(), timedelta(hours=3))
#
...
#     issue.save()
#
#     _create_spent_time(timezone.now() - timedelta(days=5, hours=5),
#                        timedelta(hours=2))
#     _create_spent_time(timezone.now() - timedelta(days=1),
#                        timedelta(hours=4))
#     _create_spent_time(timezone.now() - timedelta(days=1, hours=5),
#                        -timedelta(hours=3))
#     _create_spent_time(timezone.now() + timedelta(days=1),
#                        timedelta(hours=3))
#
...
#
#     _create_spent_time(timezone.now() - timedelta(days=2, hours=5),
#                        timedelta(hours=2))
#     _create_spent_time(timezone.now() - timedelta(days=1),
#                        timedelta(hours=4),
#                        user=another_user)
...
#     assert len(metrics) == 2
#     assertFalse(
#         any(item['user'] == another_user.id for item in metrics))
#
#
# @override_settings(TP_WEEKENDS_DAYS=[])
...
#
#     developer_metrics = next(
#         item for item in metrics if item['user'] == another_user.id)
#
#     assert len(developer_metrics['metrics']),
#                 (end - start).days + 1)
#
