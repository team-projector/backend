...
def test_has_remains(db):
    ...
    issue = IssueFactory.create(
        time_estimate=seconds(hours=3), total_time_spent=seconds(hours=2),
    )
...
def test_no_remains(db):
    ...
    issue = IssueFactory.create(
        time_estimate=seconds(hours=2), total_time_spent=seconds(hours=4),
    )
...
def test_time_estimate_is_none(db):
    ...
    issue = IssueFactory.create(
        time_estimate=None, total_time_spent=seconds(hours=4),
    )
...
def test_time_spent_is_none(db):
    ...
    issue = IssueFactory.create(
        time_estimate=seconds(hours=4), total_time_spent=None,
    )
