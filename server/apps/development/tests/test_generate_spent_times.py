...
class AdjustSpentTimesTests(TestCase):
    ...
    def test_multi_user_reset(self):
        ...
        self._create_note(Note.TYPE.time_spend, timezone.now() - timedelta(hours=6), timedelta(hours=4), user_2)
        self._create_note(Note.TYPE.time_spend, timezone.now() - timedelta(hours=5), -timedelta(hours=3), user_2)
        ...
        self._create_note(Note.TYPE.time_spend, timezone.now() - timedelta(hours=1), timedelta(hours=5), user_2)
