    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('feature', 'CH_FEATURE'), ('improvement', 'CH_IMPROVEMENT'), ('bug_fixing', 'CH_BUG_FIXING')], help_text='HT__TYPE', max_length=255, null=True, verbose_name='VN__TYPE')),
